...
public abstract class BaseAppCompatActivity extends AppCompatActivity implements IEmptyControl, IProgressDialogControl, IToastControl {
    ...
    public Dialog showNonCancelableProgressDialog() {
    ...
    public Dialog showNonCancelableProgressDialog(int resId) {
    ...
    public Dialog showNonCancelableProgressDialog(String text) {
